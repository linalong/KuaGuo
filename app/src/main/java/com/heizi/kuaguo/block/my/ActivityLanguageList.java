...
public class ActivityLanguageList extends BaseListActivity implements View.OnClickListener { //listview
...
//    IResponseCallback<DataSourceModel<ModelCommit>> callback;
    ...
    protected void initView() {
        ...
        tv_title.setText(getResources().getString(R.string.luruyuyan));
        ...
        tv_notice.setText(getResources().getString(R.string.zanwuyuyan));
        //listview
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_right:
                ...
                startActivity(this, ActivityAddLanguage.class, bundle);
                break;
            ...
            case R.id.btn_ok:
                if (type == VisibleEnum.NEXT.getCode()) {
                    ...
                    bundle3.putInt("type", VisibleEnum.NEXT.getCode());
                    startActivity(ActivityLanguageList.this, ActivityCertifiList.class, bundle3);
                } else {
                    btn_ok.setText(getResources().getString(R.string.baocun));
                }
                break;
